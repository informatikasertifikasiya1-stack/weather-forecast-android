# Default units for all countries and territories with an ISO 3166-1 alpha-2 code

Must be completed by checking the national agency website listed
in [COVERAGE.md](../docs/COVERAGE.md).

This will help putting the correct default units for every country *and* territory, since the CLDR
data is incomplete.
